...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "365a39c0846383", "SMTP username")
	...
	app := &application{
		...
		mailer: mailer.New(
			cfg.smtp.host, cfg.smtp.username, cfg.smtp.password, cfg.smtp.sender, cfg.smtp.port,
		),
	}
	err = app.server()
	if err != nil {
